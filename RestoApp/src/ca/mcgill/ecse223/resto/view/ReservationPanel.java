...
public class ReservationPanel extends SidePanel implements ActionListener {
	...
	public ReservationPanel(Controller c, RestoAppPage p) {
		...
		JLabel auto = new JLabel("put auto to find ");
		auto.setBounds(30, 530, 200, 40);
		auto.setFont(new Font("Comic sans MS", Font.PLAIN, 18));
		add(auto);

		JLabel auto2 = new JLabel("the next available one");
		auto2.setBounds(30, 550, 200, 40);
		auto2.setFont(new Font("Comic sans MS", Font.PLAIN, 18));
		add(auto2);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == addBtn) {
			try {
				...
				eventDate.set(Integer.parseInt(yearDateField.getText()), Integer.parseInt(monthDateField.getText()) - 1,
						Integer.parseInt(dayDateField.getText()));
				...
				long eventTime = Long.parseLong(hourTextField.getText()) * 3600000
